...
def main():
    ...
    parser.add_argument('gen_video', nargs='?', default='/home/lzq/paperCode/talkinghead/TalkingGaussian/output/posevideo_canonical/test/ours_None/renders/out.mp4')
    parser.add_argument('real_video', nargs='?', default='/home/lzq/paperCode/talkinghead/TalkingGaussian/output/posevideo_canonical/test/ours_None/gt/out.mp4')
