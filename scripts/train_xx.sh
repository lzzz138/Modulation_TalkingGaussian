...
python train_face.py -s $dataset -m $workspace --init_num 2000 --densify_grad_threshold 0.0005 --audio_extractor $audio_extractor --geometry_mod_multiscale $geometry_mod_multiscale
python train_fuse.py -s $dataset -m $workspace --opacity_lr 0.001 --audio_extractor $audio_extractor --geometry_mod_multiscale $geometry_mod_multiscale
...
python synthesize_fuse.py -s $dataset -m $workspace --eval --audio_extractor $audio_extractor --geometry_mod_multiscale $geometry_mod_multiscale
